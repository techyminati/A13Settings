...
public interface IGoogleBattery extends vendor.google.google_battery.V1_0.IGoogleBattery {
    ...
    static IGoogleBattery asInterface(IHwBinder iHwBinder) {
        ...
        IGoogleBattery queryLocalInterface = iHwBinder.queryLocalInterface("vendor.google.google_battery@1.2::IGoogleBattery");
        ...
        try {
            ...
            while (it.hasNext()) {
                if (it.next().equals("vendor.google.google_battery@1.2::IGoogleBattery")) {
                    return proxy;
                }
            }
    ...
    static IGoogleBattery getService(String str) throws RemoteException {
        return asInterface(HwBinder.getService("vendor.google.google_battery@1.2::IGoogleBattery", str));
    }
