...
public class VerticalWidgetRun extends WidgetRun {
    ...
    public void update(Dependency dependency) {
        ...
        if (dimensionDependency2.readyToSolve && !dimensionDependency2.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            } else if (i3 == 3 && constraintWidget3.horizontalRun.dimension.resolved) {
                int dimensionRatioSide = constraintWidget3.getDimensionRatioSide();
                if (dimensionRatioSide == -1) {
                    ConstraintWidget constraintWidget4 = this.widget;
                    f3 = constraintWidget4.horizontalRun.dimension.value;
                    f2 = constraintWidget4.getDimensionRatio();
                } else if (dimensionRatioSide == 0) {
                    f = constraintWidget.horizontalRun.dimension.value * this.widget.getDimensionRatio();
                    i = (int) (f + 0.5f);
                    ...
                    f3 = constraintWidget5.horizontalRun.dimension.value;
