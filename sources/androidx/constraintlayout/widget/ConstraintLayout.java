...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        /* JADX WARN: Removed duplicated region for block: B:119:0x01bb A[ADDED_TO_REGION] */
        /* JADX WARN: Removed duplicated region for block: B:122:0x01cb A[ADDED_TO_REGION] */
        /* JADX WARN: Removed duplicated region for block: B:127:0x01d8 A[ADDED_TO_REGION] */
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i, int i2, int i3) {
        ...
        if (paddingStart <= 0 && paddingEnd <= 0) {
            ...
            constraintWidgetContainer.measure(i, mode, i4, mode2, i5, this.mLastMeasureWidth, this.mLastMeasureHeight, paddingStart, paddingTop);
        }
        int i42 = size - paddingWidth;
        int i52 = size2 - paddingBottom;
        setSelfDimensionBehaviour(constraintWidgetContainer, mode, i42, mode2, i52);
        constraintWidgetContainer.measure(i, mode, i42, mode2, i52, this.mLastMeasureWidth, this.mLastMeasureHeight, paddingStart, paddingTop);
    }
