    ...
    */
    private static android.graphics.Typeface loadFont(android.content.Context r15, android.content.res.Resources r16, android.util.TypedValue r17, int r18, int r19, androidx.core.content.res.ResourcesCompat.FontCallback r20, android.os.Handler r21, boolean r22, boolean r23) {
        ...
        L_0x0032:
            ...
            return r14
        L_0x0035:
            java.lang.String r1 = r12.toLowerCase()     // Catch: IOException -> 0x0079, XmlPullParserException -> 0x008f
            java.lang.String r2 = ".xml"
            boolean r1 = r1.endsWith(r2)     // Catch: IOException -> 0x0079, XmlPullParserException -> 0x008f
            if (r1 == 0) goto L_0x0068
            android.content.res.XmlResourceParser r1 = r0.getXml(r4)     // Catch: IOException -> 0x0079, XmlPullParserException -> 0x008f
            androidx.core.content.res.FontResourcesParserCompat$FamilyResourceEntry r2 = androidx.core.content.res.FontResourcesParserCompat.parse(r1, r0)     // Catch: IOException -> 0x0079, XmlPullParserException -> 0x008f
            if (r2 != 0) goto L_0x0056
            java.lang.String r0 = "Failed to find font-family tag"
            android.util.Log.e(r11, r0)     // Catch: IOException -> 0x0079, XmlPullParserException -> 0x008f
            if (r9 == 0) goto L_0x0055
            r9.callbackFailAsync(r13, r10)     // Catch: IOException -> 0x0079, XmlPullParserException -> 0x008f
        L_0x0055:
            return r14
        L_0x0056:
            r1 = r15
            ...
            r7 = r21
            r8 = r22
            android.graphics.Typeface r0 = androidx.core.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch: IOException -> 0x0079, XmlPullParserException -> 0x008f
            return r0
        L_0x0068:
            r1 = r15
            android.graphics.Typeface r0 = androidx.core.graphics.TypefaceCompat.createFromResourcesFontFile(r15, r0, r4, r12, r5)     // Catch: IOException -> 0x0079, XmlPullParserException -> 0x008f
            if (r9 == 0) goto L_0x0078
            if (r0 == 0) goto L_0x0075
            r9.callbackSuccessAsync(r0, r10)     // Catch: IOException -> 0x0079, XmlPullParserException -> 0x008f
            goto L_0x0078
        L_0x0075:
            r9.callbackFailAsync(r13, r10)     // Catch: IOException -> 0x0079, XmlPullParserException -> 0x008f
        L_0x0078:
