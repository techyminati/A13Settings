    ...
    public static Pair<Drawable, String> getBtClassDrawableWithDescription(Context context, CachedBluetoothDevice cachedBluetoothDevice) {
        ...
        if (btClass != null) {
            ...
            if (majorDeviceClass == 256) {
                return new Pair<>(getBluetoothDrawable(context, 17302332), context.getString(R$string.bluetooth_talkback_computer));
            }
            if (majorDeviceClass == 512) {
                return new Pair<>(getBluetoothDrawable(context, 17302810), context.getString(R$string.bluetooth_talkback_phone));
            }
            ...
            if (majorDeviceClass == 1536) {
                return new Pair<>(getBluetoothDrawable(context, 17302843), context.getString(R$string.bluetooth_talkback_imaging));
            }
        }
        ...
        if (btClass != null) {
            if (doesClassMatch(btClass, 0)) {
                return new Pair<>(getBluetoothDrawable(context, 17302330), context.getString(R$string.bluetooth_talkback_headset));
            }
            if (doesClassMatch(btClass, 1)) {
                return new Pair<>(getBluetoothDrawable(context, 17302329), context.getString(R$string.bluetooth_talkback_headphone));
            }
        }
        return new Pair<>(getBluetoothDrawable(context, 17302841).mutate(), context.getString(R$string.bluetooth_talkback_bluetooth));
    }
