...
public class UserIconDrawable extends Drawable implements Drawable.Callback {
    ...
    public static Drawable getManagedUserDrawable(Context context) {
        ...
        return getDrawableForDisplayDensity(context, 17302402);
    }

    private static Drawable getUpdatableManagedUserDrawable(final Context context) {
        return ((DevicePolicyManager) context.getSystemService(DevicePolicyManager.class)).getDrawableForDensity("WORK_PROFILE_USER_ICON", "SOLID_COLORED", context.getResources().getDisplayMetrics().densityDpi, new Callable() { // from class: com.android.settingslib.drawable.UserIconDrawable$$ExternalSyntheticLambda0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                Drawable drawableForDisplayDensity;
                drawableForDisplayDensity = UserIconDrawable.getDrawableForDisplayDensity(context, 17302402);
    ...
    public static int getDefaultSize(Context context) {
        return context.getResources().getDimensionPixelSize(17105621);
    }
