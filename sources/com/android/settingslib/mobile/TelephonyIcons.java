...
public class TelephonyIcons {
    ...
    static {
        ...
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup6 = new SignalIcon$MobileIconGroup("1X", null, null, iArr, 0, 0, 0, 0, iArr[0], R$string.data_connection_cdma, i11);
        ...
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup14 = new SignalIcon$MobileIconGroup("5Ge", null, null, iArr, 0, 0, 0, 0, iArr[0], R$string.data_connection_5ge_html, i10);
        LTE_CA_5G_E = signalIcon$MobileIconGroup14;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup15 = new SignalIcon$MobileIconGroup("5G", null, null, iArr, 0, 0, 0, 0, iArr[0], R$string.data_connection_5g, i12);
        NR_5G = signalIcon$MobileIconGroup15;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup16 = new SignalIcon$MobileIconGroup("5G_PLUS", null, null, iArr, 0, 0, 0, 0, iArr[0], R$string.data_connection_5g_plus, i13);
        NR_5G_PLUS = signalIcon$MobileIconGroup16;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup17 = new SignalIcon$MobileIconGroup("DataDisabled", null, null, iArr, 0, 0, 0, 0, iArr[0], R$string.cell_data_off_content_description, 0);
        DATA_DISABLED = signalIcon$MobileIconGroup17;
        SignalIcon$MobileIconGroup signalIcon$MobileIconGroup18 = new SignalIcon$MobileIconGroup("NotDefaultData", null, null, iArr, 0, 0, 0, 0, iArr[0], R$string.not_default_data_content_description, 0);
        NOT_DEFAULT_DATA = signalIcon$MobileIconGroup18;
        CARRIER_MERGED_WIFI = new SignalIcon$MobileIconGroup("CWF", null, null, iArr, 0, 0, 0, 0, iArr[0], R$string.data_connection_carrier_wifi, i14);
