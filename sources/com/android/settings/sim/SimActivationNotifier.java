...
public class SimActivationNotifier {
    ...
    public void sendNetworkConfigNotification() {
        ...
        String string = this.mContext.getString(R.string.post_dsds_reboot_notification_title_with_carrier, str);
    ...
    public void sendSwitchedToRemovableSlotNotification() {
        ...
        if (TextUtils.isEmpty(activeCarrierName)) {
            ...
            str = this.mContext.getString(R.string.switch_to_removable_notification, activeCarrierName);
        }
