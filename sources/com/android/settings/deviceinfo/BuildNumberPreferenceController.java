...
public class BuildNumberPreferenceController extends BasePreferenceController implements LifecycleObserver, OnStart {
        ...
        if (!this.mUm.isAdminUser() && !this.mUm.isDemoUser()) {
            ...
            if (i > 0) {
                ...
                if (i2 == 0 && !this.mProcessingLastDevHit) {
                    ...
                    Toast makeText = Toast.makeText(context, resources.getQuantityString(R.plurals.show_dev_countdown, i3, Integer.valueOf(i3)), 0);
                ...
                Toast makeText2 = Toast.makeText(this.mContext, (int) R.string.show_dev_already, 1);
    ...
    private void enableDevelopmentSettings() {
        ...
        Toast makeText = Toast.makeText(this.mContext, (int) R.string.show_dev_on, 1);
        this.mDevHitToast = makeText;
        makeText.show();
    }
