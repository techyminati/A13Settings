    ...
    */
    public static java.lang.String readAll(java.net.URL r6) throws java.io.IOException {
        /*
            ...
            r0 = 0
            java.net.URLConnection r6 = r6.openConnection()     // Catch: all -> 0x0078, Exception -> 0x007d
            javax.net.ssl.HttpsURLConnection r6 = (javax.net.ssl.HttpsURLConnection) r6     // Catch: all -> 0x0078, Exception -> 0x007d
            r1 = 10000(0x2710, float:1.4013E-41)
            r6.setReadTimeout(r1)     // Catch: all -> 0x006e, Exception -> 0x0073
            r6.setConnectTimeout(r1)     // Catch: all -> 0x006e, Exception -> 0x0073
            java.lang.String r1 = "GET"
            r6.setRequestMethod(r1)     // Catch: all -> 0x006e, Exception -> 0x0073
            r1 = 1
            r6.setDoInput(r1)     // Catch: all -> 0x006e, Exception -> 0x0073
            r6.connect()     // Catch: all -> 0x006e, Exception -> 0x0073
            int r1 = r6.getResponseCode()     // Catch: all -> 0x006e, Exception -> 0x0073
            int r2 = r6.getResponseCode()     // Catch: all -> 0x006e, Exception -> 0x0073
            r3 = 200(0xc8, float:2.8E-43)
            if (r2 != r3) goto L_0x0057
            java.io.BufferedInputStream r1 = new java.io.BufferedInputStream     // Catch: all -> 0x006e, Exception -> 0x0073
            java.io.InputStream r2 = r6.getInputStream()     // Catch: all -> 0x006e, Exception -> 0x0073
            r1.<init>(r2)     // Catch: all -> 0x006e, Exception -> 0x0073
            java.lang.String r0 = readAll(r1)     // Catch: Exception -> 0x0055, all -> 0x0082
        ...
        L_0x0055:
            ...
            goto L_0x0081
        L_0x0057:
            java.io.IOException r2 = new java.io.IOException     // Catch: all -> 0x006e, Exception -> 0x0073
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch: all -> 0x006e, Exception -> 0x0073
            r3.<init>()     // Catch: all -> 0x006e, Exception -> 0x0073
            java.lang.String r4 = "HTTP error code: "
            r3.append(r4)     // Catch: all -> 0x006e, Exception -> 0x0073
            r3.append(r1)     // Catch: all -> 0x006e, Exception -> 0x0073
            java.lang.String r1 = r3.toString()     // Catch: all -> 0x006e, Exception -> 0x0073
            r2.<init>(r1)     // Catch: all -> 0x006e, Exception -> 0x0073
            throw r2     // Catch: all -> 0x006e, Exception -> 0x0073
        L_0x006e:
            r1 = move-exception
            r5 = r1
            r1 = r0
    ...
    public class DSUPackage {
        ...
        boolean isSupported() {
            ...
            if (this.mSPL != null) {
                ...
                Slog.i("DSULOADER", this.mName + " isSupported " + z2);
                return z2;
            }
            Slog.i("DSULOADER", this.mName + " isSupported " + z2);
            return z2;
