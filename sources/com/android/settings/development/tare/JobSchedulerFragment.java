...
public class JobSchedulerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() { // from class: com.android.settings.development.tare.JobSchedulerFragment.1
            ...
            public boolean onChildClick(ExpandableListView expandableListView2, View view, int i, int i2, long j) {
                Toast.makeText(JobSchedulerFragment.this.getActivity(), (String) savedTabsListAdapter.getChild(i, i2), 0).show();
                return true;
            }
        });
        return inflate;
    ...
    public class SavedTabsListAdapter extends BaseExpandableListAdapter {
        ...
        public SavedTabsListAdapter() {
            Resources resources = JobSchedulerFragment.this.getActivity().getResources();
            ...
            this.mChildren = new String[][]{new String[0], new String[0], this.mResources.getStringArray(R.array.tare_min_satiated_balance_subfactors), this.mResources.getStringArray(R.array.tare_modifiers_subfactors), this.mResources.getStringArray(R.array.tare_job_scheduler_actions), this.mResources.getStringArray(R.array.tare_rewards_subfactors)};
            this.mInflater = LayoutInflater.from(JobSchedulerFragment.this.getActivity());
        }
