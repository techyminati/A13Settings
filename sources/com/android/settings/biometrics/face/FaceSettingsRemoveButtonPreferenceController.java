...
public class FaceSettingsRemoveButtonPreferenceController extends BasePreferenceController implements View.OnClickListener {
    ...
    public static class ConfirmRemoveDialog extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            builder.setTitle(R.string.security_settings_face_settings_remove_dialog_title).setMessage(this.mIsConvenience ? R.string.security_settings_face_settings_remove_dialog_details_convenience : R.string.security_settings_face_settings_remove_dialog_details).setPositiveButton(R.string.delete, this.mOnClickListener).setNegativeButton(R.string.cancel, this.mOnClickListener);
