...
public class BluetoothSliceBuilder {
    ...
    public static Slice getSlice(Context context) {
        ...
        IconCompat createWithResource = IconCompat.createWithResource(context, 17302841);
    ...
    public static Intent getIntent(Context context) {
        ...
        return SliceBuilderUtils.buildSearchResultPageIntent(context, BluetoothDashboardFragment.class.getName(), (String) null, charSequence, 747, (int) R.string.menu_key_connected_devices).setClassName(context.getPackageName(), SubSettings.class.getName()).setData(new Uri.Builder().appendPath("bluetooth").build());
    }
