        ...
        if (i == 1) {
            ...
            if (i2 < 0) {
                ...
                if (charSequence != null) {
                    str3 = getString((int) R.string.bluetooth_ask_enablement, new Object[]{charSequence});
                } else {
                    str3 = getString((int) R.string.bluetooth_ask_enablement_no_name);
                }
                alertParams.mMessage = str3;
            } else if (i2 == 0) {
                CharSequence charSequence2 = this.mAppLabel;
                if (charSequence2 != null) {
                    str2 = getString((int) R.string.bluetooth_ask_enablement_and_lasting_discovery, new Object[]{charSequence2});
                } else {
                    str2 = getString((int) R.string.bluetooth_ask_enablement_and_lasting_discovery_no_name);
                }
                alertParams.mMessage = str2;
            } else {
                CharSequence charSequence3 = this.mAppLabel;
                if (charSequence3 != null) {
                    str = getString((int) R.string.bluetooth_ask_enablement_and_discovery, new Object[]{charSequence3, Integer.valueOf(i2)});
                } else {
                    str = getString((int) R.string.bluetooth_ask_enablement_and_discovery_no_name, new Object[]{Integer.valueOf(i2)});
                }
            ...
            if (charSequence4 != null) {
                str4 = getString((int) R.string.bluetooth_ask_disablement, new Object[]{charSequence4});
            } else {
                str4 = getString((int) R.string.bluetooth_ask_disablement_no_name);
            }
            alertParams.mMessage = str4;
        }
        alertParams.mPositiveButtonText = getString((int) R.string.allow);
