...
public class WifiCallingSliceHelper {
    ...
    private Slice getWifiCallingSlice(Uri uri, boolean z, int i) {
        ...
        return new ListBuilder(this.mContext, uri, -1L).setAccentColor(Utils.getColorAccentDefaultColor(this.mContext)).addRow(new ListBuilder.RowBuilder().setTitle(resourcesForSubId.getText(R.string.wifi_calling_settings_title)).addEndItem(SliceAction.createToggle(getBroadcastIntent("com.android.settings.wifi.calling.action.WIFI_CALLING_CHANGED", z), null, z)).setPrimaryAction(SliceAction.createDeeplink(getActivityIntent("android.settings.WIFI_CALLING_SETTINGS"), createWithResource, 0, resourcesForSubId.getText(R.string.wifi_calling_settings_title)))).build();
    }
    ...
    private Slice getWifiCallingPreferenceSlice(boolean z, int i, Uri uri, int i2) {
        ...
        if (z) {
            accentColor.addRow(wifiPreferenceRowBuilder(accentColor, 17041716, "com.android.settings.slice.action.WIFI_CALLING_PREFERENCE_WIFI_ONLY", i == 0, i2));
        }
        accentColor.addRow(wifiPreferenceRowBuilder(accentColor, 17041717, "com.android.settings.slice.action.WIFI_CALLING_PREFERENCE_WIFI_PREFERRED", i == 2, i2));
        accentColor.addRow(wifiPreferenceRowBuilder(accentColor, 17041715, "com.android.settings.slice.action.WIFI_CALLING_PREFERENCE_CELLULAR_PREFERRED", i == 1, i2));
    ...
    private CharSequence getWifiCallingPreferenceSummary(int i, int i2) {
        Resources resourcesForSubId = getResourcesForSubId(i2);
        if (i == 0) {
            return resourcesForSubId.getText(17041716);
        }
        if (i == 1) {
            return resourcesForSubId.getText(17041715);
        }
        if (i != 2) {
            return null;
        }
        return resourcesForSubId.getText(17041717);
    }
