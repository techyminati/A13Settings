...
public class AutoSyncWorkDataPreferenceController extends AutoSyncPersonalDataPreferenceController {
    ...
    public boolean isAvailable() {
        return this.mUserHandle != null && !this.mUserManager.isManagedProfile() && !this.mUserManager.isLinkedUser() && this.mUserManager.getProfiles(UserHandle.myUserId()).size() > 1;
    }
}
