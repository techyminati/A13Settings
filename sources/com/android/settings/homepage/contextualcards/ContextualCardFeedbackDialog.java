...
public class ContextualCardFeedbackDialog extends AlertActivity implements DialogInterface.OnClickListener {
    protected void onCreate(Bundle bundle) {
        ...
        alertParams.mMessage = getText((int) R.string.contextual_card_feedback_confirm_message);
        alertParams.mPositiveButtonText = getText((int) R.string.contextual_card_feedback_send);
        alertParams.mPositiveButtonListener = this;
        alertParams.mNegativeButtonText = getText((int) R.string.skip_label);
        setupAlert();
    }
