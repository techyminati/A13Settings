...
public final class Utils extends com.android.settingslib.Utils {
    ...
    public static void prepareCustomPreferencesList(ViewGroup viewGroup, View view, View view2, boolean z) {
        if (view2.getScrollBarStyle() == 33554432) {
            int dimensionPixelSize = view2.getResources().getDimensionPixelSize(17105464);
    ...
    public static void forceCustomPadding(View view, boolean z) {
        view.setPaddingRelative(z ? view.getPaddingStart() : 0, 0, z ? view.getPaddingEnd() : 0, view.getResources().getDimensionPixelSize(17105464));
    }
    ...
    public static boolean isSettingsIntelligence(Context context) {
        return TextUtils.equals(context.getPackageManager().getPackagesForUid(Binder.getCallingUid())[0], context.getString(androidx.window.R.string.config_settingsintelligence_package_name));
    }
    ...
    public static int getHomepageIconColorHighlight(Context context) {
        return com.android.settingslib.Utils.getColorAttrDefaultColor(context, 16842810);
    }
}
