...
public class AllowBindAppWidgetActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        alertParams.mTitle = getString((int) R.string.allow_bind_app_widget_activity_allow_bind_title);
        alertParams.mMessage = getString((int) R.string.allow_bind_app_widget_activity_allow_bind, new Object[]{charSequence, widgetLabel});
        alertParams.mPositiveButtonText = getString((int) R.string.create);
        ...
        checkBox.setText(getString((int) R.string.allow_bind_app_widget_activity_always_allow_bind, new Object[]{charSequence}));
