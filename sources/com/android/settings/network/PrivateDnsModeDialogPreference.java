...
public class PrivateDnsModeDialogPreference extends CustomDialogPreferenceCompat implements DialogInterface.OnClickListener, RadioGroup.OnCheckedChangeListener, TextWatcher {
    ...
    static {
        ...
        hashMap.put(1, Integer.valueOf((int) R.id.private_dns_mode_off));
        hashMap.put(2, Integer.valueOf((int) R.id.private_dns_mode_opportunistic));
        hashMap.put(3, Integer.valueOf((int) R.id.private_dns_mode_provider));
    }
    ...
    public void onBindDialogView(View view) {
        ...
        this.mRadioGroup.check(PRIVATE_DNS_MAP.getOrDefault(Integer.valueOf(this.mMode), Integer.valueOf((int) R.id.private_dns_mode_opportunistic)).intValue());
