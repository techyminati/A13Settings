...
public class MobileDataDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        if (i2 == 1) {
            ...
            return new AlertDialog.Builder(context).setTitle(context.getString(R.string.sim_change_data_title, str2)).setMessage(context.getString(R.string.sim_change_data_message, str2, str)).setPositiveButton(context.getString(R.string.sim_change_data_ok, str2), this).setNegativeButton(R.string.cancel, (DialogInterface.OnClickListener) null).create();
        }
