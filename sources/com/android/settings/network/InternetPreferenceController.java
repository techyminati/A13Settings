...
public class InternetPreferenceController extends AbstractPreferenceController implements LifecycleObserver, SummaryUpdater.OnSummaryChangeListener, InternetUpdater.InternetChangeListener {
    ...
    static {
        ...
        sIconMap = hashMap;
        hashMap.put(0, Integer.valueOf((int) R.drawable.ic_no_internet_unavailable));
        sIconMap.put(1, Integer.valueOf((int) R.drawable.ic_no_internet_available));
        sIconMap.put(2, Integer.valueOf((int) R.drawable.ic_wifi_signal_4));
        sIconMap.put(3, Integer.valueOf((int) R.drawable.ic_network_cell));
        sIconMap.put(4, Integer.valueOf((int) R.drawable.ic_settings_ethernet));
        HashMap hashMap2 = new HashMap();
        sSummaryMap = hashMap2;
        hashMap2.put(0, Integer.valueOf((int) R.string.condition_airplane_title));
        sSummaryMap.put(1, Integer.valueOf((int) R.string.networks_available));
        sSummaryMap.put(2, 0);
        sSummaryMap.put(3, 0);
        sSummaryMap.put(4, Integer.valueOf((int) R.string.to_switch_networks_disconnect_ethernet));
    }
