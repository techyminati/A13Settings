...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
            ...
            public void onViewReleased(View view, float f, float f2) {
                ...
                if (f2 >= 0.0f) {
                    ...
                    if (BottomSheetBehavior.this.shouldSkipHalfExpandedStateWhenDragging()) {
                        ...
                        if (bottomSheetBehavior3.shouldExpandOnUpwardDrag(currentTimeMillis, (top3 * 100.0f) / bottomSheetBehavior3.parentHeight)) {
                        ...
                        if (top3 > i4) {
                            ...
                            i = bottomSheetBehavior4.getExpandedOffset();
                        }
                    }
                }
                ...
                if (f2 >= 0.0f) {
                    ...
                    if (BottomSheetBehavior.this.shouldSkipHalfExpandedStateWhenDragging()) {
                        ...
                        if (top3 > i4) {
                            ...
                            i2 = bottomSheetBehavior4.getExpandedOffset();
                        }
                    }
                }
                BottomSheetBehavior bottomSheetBehavior5 = BottomSheetBehavior.this;
    ...
    private float getYVelocity() {
        ...
        velocityTracker.computeCurrentVelocity(SecurityContentManager.DEFAULT_ORDER, this.maximumVelocity);
