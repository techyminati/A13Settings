...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void loadDefaultStateFromAttributes(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        int i5 = R$styleable.Badge_badgeRadius;
        if (obtainStyledAttributes.hasValue(i5)) {
            this.badgeRadius = obtainStyledAttributes.getDimensionPixelSize(i5, (int) this.badgeRadius);
        }
        int i6 = R$styleable.Badge_badgeWidePadding;
        if (obtainStyledAttributes.hasValue(i6)) {
            this.badgeWidePadding = obtainStyledAttributes.getDimensionPixelSize(i6, (int) this.badgeWidePadding);
        }
        int i7 = R$styleable.Badge_badgeWithTextRadius;
        if (obtainStyledAttributes.hasValue(i7)) {
            this.badgeWithTextRadius = obtainStyledAttributes.getDimensionPixelSize(i7, (int) this.badgeWithTextRadius);
        }
