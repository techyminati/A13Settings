                ...
                if (!skipMonth(item, item2, Long.valueOf(longValue), Long.valueOf(longValue2))) {
                    ...
                    if (longValue < item.longValue()) {
                        if (adapter.isFirstInRow(max)) {
                            ...
                            i = materialCalendarGridView.getChildAtPosition(max - 1).getRight();
                        } else {
                            i = materialCalendarGridView.getChildAtPosition(max - 1).getLeft();
                        }
                        i2 = max;
                    } else {
                    ...
                    if (longValue2 > item2.longValue()) {
                        if (adapter.isLastInRow(min)) {
                            ...
                            i3 = materialCalendarGridView.getChildAtPosition(min).getRight();
                        } else {
                            i3 = materialCalendarGridView.getChildAtPosition(min).getLeft();
                        }
                        i4 = min;
                    } else {
