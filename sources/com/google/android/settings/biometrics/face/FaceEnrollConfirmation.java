...
public class FaceEnrollConfirmation extends FragmentActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        footerBarMixin.setPrimaryButton(new FooterButton.Builder(this).setText(R.string.security_settings_face_enroll_done).setListener(new View.OnClickListener() { // from class: com.google.android.settings.biometrics.face.FaceEnrollConfirmation$$ExternalSyntheticLambda0
