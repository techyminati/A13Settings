...
import com.google.android.settings.biometrics.face.FaceEnrollEnrolling;
...
public class FaceEnrollEnrolling extends FragmentActivity implements FaceEnrollSidecar.Listener {
    ...
    private Runnable mMultiAngleNotCenteredBeforeZeroZeroRunnable = new Runnable() { // from class: com.google.android.settings.biometrics.face.FaceEnrollEnrolling$$ExternalSyntheticLambda7
        @Override // java.lang.Runnable
        public final void run() {
            FaceEnrollEnrolling.this.lambda$new$0();
        }
    };
    private Runnable mNoProgressTimeoutRunnable = new Runnable() { // from class: com.google.android.settings.biometrics.face.FaceEnrollEnrolling$$ExternalSyntheticLambda6
        @Override // java.lang.Runnable
        public final void run() {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.mFromSetupWizard) {
            this.mFooterBarMixin.setSecondaryButton(new FooterButton.Builder(this).setText(R.string.face_enrolling_do_it_later).setListener(new View.OnClickListener() { // from class: com.google.android.settings.biometrics.face.FaceEnrollEnrolling$$ExternalSyntheticLambda3
            ...
            this.mFooterBarMixin.setSecondaryButton(new FooterButton.Builder(this).setText(R.string.face_enrolling_gaze_dialog_cancel).setListener(new View.OnClickListener() { // from class: com.google.android.settings.biometrics.face.FaceEnrollEnrolling$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    FaceEnrollEnrolling.this.onButtonNegative(view);
                }
    ...
    private void showGazeDialog() {
        ...
        newInstance.setButtonListener(new DialogInterface.OnClickListener() { // from class: com.google.android.settings.biometrics.face.FaceEnrollEnrolling$$ExternalSyntheticLambda1
    ...
    public void onEnrollmentProgressChange(int i, int i2) {
        ...
        this.mHandler.postDelayed(new Runnable() { // from class: com.google.android.settings.biometrics.face.FaceEnrollEnrolling$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void showPartialEnrollmentDialog() {
        FaceEnrollDialogFactory.newBuilder(this).setTitle(R.string.security_settings_face_enroll_partial_title).setMessage(R.string.security_settings_face_enroll_partial_message).setPositiveButton(R.string.security_settings_face_enroll_dialog_ok, new DialogInterface.OnClickListener() { // from class: com.google.android.settings.biometrics.face.FaceEnrollEnrolling$$ExternalSyntheticLambda2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                FaceEnrollEnrolling.this.lambda$showPartialEnrollmentDialog$3(dialogInterface, i);
            }
        }).setNegativeButton(R.string.security_settings_face_enroll_partial_start_over, new DialogInterface.OnClickListener() { // from class: com.google.android.settings.biometrics.face.FaceEnrollEnrolling$$ExternalSyntheticLambda0
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                FaceEnrollEnrolling.this.lambda$showPartialEnrollmentDialog$4(dialogInterface, i);
            }
        }).setOnBackKeyListener(new FaceEnrollDialogFactory.OnBackKeyListener() { // from class: com.google.android.settings.biometrics.face.FaceEnrollEnrolling$$ExternalSyntheticLambda4
    ...
    private void restartEnrollmentFromDialog(final DialogInterface dialogInterface) {
        ...
        if (findNewlyEnrolledFace == null) {
            ...
            faceManager.remove(findNewlyEnrolledFace, this.mUserId, new FaceManager.RemovalCallback() { // from class: com.google.android.settings.biometrics.face.FaceEnrollEnrolling.2
