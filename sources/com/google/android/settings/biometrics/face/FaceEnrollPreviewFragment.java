...
import com.google.android.settings.biometrics.face.FaceEnrollPreviewFragment;
...
public class FaceEnrollPreviewFragment extends Fragment implements FaceEnrollSidecar.Listener, FaceEnrollSidecar.PreviewSurfaceProvider {
    ...
    private Size chooseOptimalSize(Size[] sizeArr) {
        return (Size) Collections.min(Arrays.asList(sizeArr), new Comparator<Size>() { // from class: com.google.android.settings.biometrics.face.FaceEnrollPreviewFragment.5
