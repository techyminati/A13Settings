...
public class ContextualSuggestionFragment extends InstrumentedFragment implements SuggestionController.ServiceConnectionListener {
    ...
    void loadSuggestions() {
        ...
        ThreadUtils.postOnBackgroundThread(new Runnable() { // from class: com.google.android.settings.dashboard.suggestions.ContextualSuggestionFragment$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                ContextualSuggestionFragment.this.lambda$loadSuggestions$1();
            }
        });
    }
    ...
    public /* synthetic */ void lambda$loadSuggestions$1() {
        ...
        Log.d("ContextualSuggestFrag", "Loaded suggests: " + valueOf);
        ThreadUtils.postOnMainThread(new Runnable() { // from class: com.google.android.settings.dashboard.suggestions.ContextualSuggestionFragment$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                ContextualSuggestionFragment.this.lambda$loadSuggestions$0(suggestions);
            }
        });
    }
    ...
    public void lambda$loadSuggestions$0(List<Suggestion> list) {
        ...
        final Suggestion suggestion = list.get(0);
        ...
        this.mSuggestionTile.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.settings.dashboard.suggestions.ContextualSuggestionFragment$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ContextualSuggestionFragment.lambda$updateState$2(suggestion, view);
            }
        });
    ...
    public static /* synthetic */ void lambda$updateState$2(Suggestion suggestion, View view) {
        try {
            ...
            Log.w("ContextualSuggestFrag", "Failed to start suggestion " + ((Object) suggestion.getTitle()));
        }
    }

    int getSuggestionTitle(String str) {
        str.hashCode();
    ...
    int getSuggestionSummary(String str) {
        str.hashCode();
        if (str.equals(SUW_PACKAGE)) {
    ...
    void showSuggestionTile(boolean z) {
