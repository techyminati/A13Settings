...
public class LocationSetting implements Queryable {
    ...
    public Cursor getAccessCursor(Context context, SliceData sliceData) {
        ...
        String intentString = getIntentString(context, "location", LocationSettings.class, getScreenTitle(context), R.string.menu_key_location);
    ...
    private int getCurrentValue(Context context) {
        return Settings.Secure.getIntForUser(context.getContentResolver(), "location_mode", 0, ActivityManager.getCurrentUser()) != 0 ? 1 : 0;
    }
