...
public class MagnificationSetting implements Queryable {
    ...
    public Cursor getAccessCursor(Context context, SliceData sliceData) {
        ...
        String intentString = getIntentString(context, "magnification_preference_screen", AccessibilitySettings.class, getScreenTitle(context), R.string.menu_key_accessibility);
