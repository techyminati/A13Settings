...
public class NfcSetting implements Queryable {
    ...
    public Cursor getAccessCursor(Context context, SliceData sliceData) {
        ...
        String intentString = getIntentString(context, "nfc", ConnectedDeviceDashboardFragment.class, getScreenTitle(context), R.string.menu_key_connected_devices);
    ...
    private static int getAvailability(Context context, NfcAdapter nfcAdapter) {
        ...
        return (Settings.Global.getInt(context.getContentResolver(), "airplane_mode_on", 0) != 1 || NfcPreferenceController.isToggleableInAirplaneMode(context)) ? 0 : 1;
    }
