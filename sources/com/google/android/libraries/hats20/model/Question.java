...
public abstract class Question implements Parcelable {
    ...
    public static Question[] getQuestionsFromSurveyDefinition(JSONObject jSONObject) throws JSONException {
        ...
        while (i < jSONArray.length()) {
            ...
            i++;
            Log.d("HatsLibQuestionClass", String.format(Locale.US, "Parsed question %d of %d with content %s", Integer.valueOf(i), Integer.valueOf(jSONArray.length()), question.toString()));
        }
        return questionArr;
    }
}
