...
public class PromptDialogDelegate {
    ...
    public static Bundle createArgs(String str, SurveyController surveyController, AnswerBeacon answerBeacon, Integer num, Integer num2, boolean z) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        inflate.findViewById(R$id.hats_lib_prompt_no_thanks_wrapper).setOnTouchListener(new View.OnTouchListener(this) { // from class: com.google.android.libraries.hats20.PromptDialogDelegate.1
        ...
        inflate.findViewById(R$id.hats_lib_prompt_take_survey_wrapper).setOnTouchListener(new View.OnTouchListener(this) { // from class: com.google.android.libraries.hats20.PromptDialogDelegate.2
            @Override // android.view.View.OnTouchListener
            public boolean onTouch(View view, MotionEvent motionEvent) {
    ...
    private void updatePromptBannerText(View view, String str) {
        ...
        LayoutUtils.fitTextInTextViewWrapIfNeeded(DimensionConfigurationHelper.getPromptWidthPx(this.context, this.maxPromptWidth) - (resources.getDimensionPixelSize(R$dimen.hats_lib_prompt_banner_left_padding) + resources.getDimensionPixelSize(R$dimen.hats_lib_prompt_banner_right_padding)), 20, 16, str, autoResizeTextView);
