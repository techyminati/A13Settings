...
public final class HybridBinarizer extends GlobalHistogramBinarizer {
    ...
    public BitMatrix getBlackMatrix() throws NotFoundException {
        ...
        if (width < 40 || height < 40) {
            ...
            calculateThresholdForBlock(matrix, i, i2, width, height, calculateBlackPoints, bitMatrix2);
            ...
            while (i9 < i) {
                ...
                if (i14 - i15 <= 24) {
                    ...
                    if (i6 > 0 && i9 > 0) {
                        ...
                        int i21 = i9 - 1;
                        c = 2;
                        int i22 = ((iArr[i20][i9] + (iArr[i6][i21] * 2)) + iArr[i20][i21]) >> 2;
                        if (i15 < i22) {
                            i19 = i22;
                        }
                        iArr[i6][i9] = i19;
